//! Legacy IPC protocol surface — daemon / client tarpc service, control
//! socket handshake. Pending removal; consumers should migrate to
//! [`crate::events`] for stream-event types and to
//! [`crate::runtime::SessionRuntime`] for direct in-process calls.
...
pub use crate::events::{
    BlockId, BlockKind, DiffLine, PermissionId, PermissionRequest, PermissionResponseWire,
    ShellState, StreamFrame,
};
