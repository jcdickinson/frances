...
//! `frances-harness` (producer of native tool output) and the
...
//!   section. Native producers construct it; the frontend picks a rendering by kind.
...
pub struct EntityEnvelope {
    pub entity_id: Uuid,
    /// Open set — producers mint kinds freely;
