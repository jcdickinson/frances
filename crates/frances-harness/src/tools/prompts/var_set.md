...
I use this to remember structured state across turns: scratch notes, intermediate results, plans I intend to come back to. Other tools in the context can read the same variables, so this is also how I hand structured data to them.
